...
export function AnalysisRuntimeProvider({ children }) {
  // Lives above route pages so the analysis workspace survives SPA navigation.
  // A full browser refresh/reload intentionally creates a new provider and
  // therefore starts a fresh analysis session.
